...
To help orient newcomers to the code base, we will trace the complete path that data takes through the system, from speech to displayed summary, when the system is up and running.
...
That is the end-to-end process beginning from a capture device client, transiting through the server, and ending at the iOS client.
