...
class WhisperTranscriptionActor:
    ...
    def load_models(self, config):
        logging.info(f"Transcription model: {config.model}")
    ...
    async def transcribe_audio(self, main_audio_filepath, voice_sample_filepath=None, speaker_name=None):
        ...
        logging.info(f"Transcribing audio file: {main_audio_filepath}")
        # Transcription
        ...
        logging.info(f"Initial transcription complete. Total segments: {len(initial_transcription)}")
        ...
        logging.info(f"Transcription complete. Total segments: {len(final_transcription_data)}")
        ...
        logging.info("Transcription converted to Pydantic model.")
