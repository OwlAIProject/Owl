...
class CaptureDirectory:
    ...
    def get_capture_filepath(self, capture_uuid: str, format: str, start_time: datetime, device_type: DeviceType) -> str:
        ...
        # Filepath: {directory}/{date}/{device}/{timestamp}_{capture_uuid}.{ext}
        dir = os.path.join(self._config.captures.directory, self._date_string(timestamp=start_time), device_type.value)
    ...
    def get_capture_segment_directory(self, capture_file: Capture):
        ...
        # capture file, i.e., {directory}/{date}/{device}/{capture_timestamp}_{capture_uuid}
